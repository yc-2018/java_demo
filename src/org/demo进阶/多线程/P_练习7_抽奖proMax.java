...
/*
        ...
        */
        ...
        //创建多线程要运行的参数对象
        MyCallable_ mc = new MyCallable_(list);
...
class MyCallable_ implements Callable {
    ArrayList<Integer> list;

    public MyCallable_(ArrayList<Integer> list) {
        this.list = list;
    }
